...
namespace ClassLibraryServer.Struct
{
    ...
    public unsafe struct IMAGE_IMPORT_BY_NAME64
    {
    ...
    public unsafe class Interop
    {
        ...
        [DllImport(KERNEL_DLL, CallingConvention = CALLING_CONVENTION, EntryPoint = "IsBadReadPtr")]
        public static extern bool IsBadReadPtr(void* lpBase, ulong ucb);

        [DllImport(DBGHELP_DLL, CallingConvention = CALLING_CONVENTION, EntryPoint = "ImageDirectoryEntryToData")]
        public static extern void* ImageDirectoryEntryToData(void* Base, bool MappedAsImage, ulong DirectoryEntry, out ulong Size);
        [DllImport(DBGHELP_DLL, CallingConvention = CALLING_CONVENTION, EntryPoint = "ImageDirectoryEntryToData")]
